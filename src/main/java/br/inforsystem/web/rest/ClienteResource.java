...
import br.inforsystem.domain.FiltrarCliente;
...
public class ClienteResource {
    ...
    @PostMapping("/clientesFiltrar")
    @Timed
    public List<Cliente> filtrarCliente(@RequestBody FiltrarCliente f) {
        
    	String SQL = "SELECT * FROM cliente WHERE "+f.getCampoConsulta()+" LIKE '%"+f.getValorConsulta()+"%' LIMIT "+f.getLimitConsulta();
		...
		while (rs.next()) {
		lista.add(clienteRepository.findOne(rs.getLong("id")));
